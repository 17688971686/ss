(function() {
	...
	function deptInfoMaintain($http,$compile) {	
		var url_deptInfoMaintain = "/contents/app/managementHomePage/deptInfoMaintain/data/list.json";
//		var url_back = '#/projectprocess';
		...
		function grid(vm) {
			...
			var dataSource = new kendo.data.DataSource({
				type : 'odata',
				transport : common.kendoGridConfig().transport(url_deptInfoMaintain),
