...
//					}
        ...
        function projectUpdateShenBaoRecordsGird(vm){
            ...
            var dataSource = new kendo.data.DataSource({
                type : 'odata',
                transport : common.kendoGridConfig().transport(url_shenbao+"?isUpdate=true"),
                schema : common.kendoGridConfig().schema({
                    id : "id"
//					fields : {
//						createdDate : {
		...
		function getShenBaoInfoById(vm){
			var httpOptions = {
				...
				var httpSuccess = function success(response) {
					...
					//日期展示
					//vm.model.beginDate=common.formatDateByStr(vm.model.beginDate,"yyyy-MM");//开工日期
					//vm.model.endDate=common.formatDateByStr(vm.model.endDate,"yyyy-MM");//竣工日期
