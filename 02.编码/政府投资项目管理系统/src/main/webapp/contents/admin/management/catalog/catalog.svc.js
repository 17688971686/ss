(function() {
	...
	function catalog($http,$location) {
		...
		var service = {
				...
				deleteSecondaryCatalog : deleteSecondaryCatalog,//删除次级目录
				createSecondCatalog : createSecondCatalog,//创建次级目录
				changeSecondCatalog : changeSecondCatalog,//更改次级目录信息
				getSecondCatalogById : getSecondCatalogById,//根据二级目录id获取二级目录信息
				grid_projectType : grid_projectType,//项目类型信息列表
				grid_constructionType : grid_constructionType,//建设类型列表
				removeSecondCatalogs : removeSecondCatalogs,//批量删除次级目录
				deleteCatalog : deleteCatalog,//删除主目录
				removeFirstCatalogs : removeFirstCatalogs//批量删除主目录
		};
		return service;
