...
/**********************begin#年度计划编制***************************************/
	        ...
	        .state('yearPlan_packList', {
	            url: '/yearPlan/packList',
	            templateUrl: '/management/packPlan/html/packList',
	            controller: 'yearPlanCtrl',
	            controllerAs: 'vm'
	        })
	        //打包计划 编辑页
	        .state('yearPlan_packEdit', {
	            url: '/yearPlan/packEdit/:id',
	            templateUrl: '/management/packPlan/html/packEdit',
	            controller: 'yearPlanCtrl',
	            controllerAs: 'vm'
	        })
	        /*************************************************end 新增加的打包计划*/
...
/**********************begin#工作台***************************************/
	        ...
	        //个人已办--下一年度计划
	        .state('task_complate_yearPlan', {
	            url: '/task/complate_yearPlan/:id',
	            templateUrl: '/management/task/html/handle',
	            controller: 'taskYearPlanCtrl',
	            controllerAs: 'vm'
	        })
