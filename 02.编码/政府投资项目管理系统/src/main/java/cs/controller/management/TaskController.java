...
public class TaskController {
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_Audit(HttpServletRequest request, @RequestParam(required = false) String leixin) {
        String str = "audit";
    ...
    @RequestMapping(name = "获取审批类个人待办数据", path = "audit2", method = RequestMethod.GET)
    @ResponseBody
    public PageModelDto<ShenBaoInfoRun> getToDoAudit2(ODataObjNew odataObj, String leixin) {
        List<ShenBaoInfoRun> shenBaoInfoRuns = processService.findAuditRunByOdata(odataObj, leixin);
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_Audit_Other(HttpServletRequest request, @RequestParam(required = false) String leixin) {
        String str = "audit";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getTask_user(odataObj, str, leixin);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_yuepi(HttpServletRequest request, @RequestParam(required = false) String leixin) throws ParseException {
        String str = "audit";
        ODataObjNew odataObj = new ODataObjNew(request);
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_yearPlan(HttpServletRequest request) throws ParseException {
        String str = "yearPlan";
        ODataObjNew odataObj = new ODataObjNew(request);
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_Plan(HttpServletRequest request, @RequestParam(required = false) String leixin) throws ParseException {
        String str = "plan";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getTask_user(odataObj, str, leixin);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_Plan_other(HttpServletRequest request, @RequestParam(required = false) String leixin) throws ParseException {
        String str = "plan";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getTask_user(odataObj, str, leixin);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getToDo_all(HttpServletRequest request) throws ParseException {
        String str = "all";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getTask_user(odataObj, str);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getAudit_complete(HttpServletRequest request) throws ParseException {
        String str = "audit";
        ODataObjNew odataObj = new ODataObjNew(request);
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getAudit_completePlan(HttpServletRequest request) throws ParseException {
        String str = "plan";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getAudit_complete(odataObj, str);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    PageModelDto<ShenBaoInfoDto> getAudit_completeYearPlan(HttpServletRequest request) throws ParseException {
        String str = "yearPlan";
        ODataObjNew odataObj = new ODataObjNew(request);
        PageModelDto<ShenBaoInfoDto> shenBaoInfoDtos = processService.getAudit_complete(odataObj, str);
        //关于流程记录根据创建用户id查找到名称用于显示
    ...
    public @ResponseBody
    List<HistoricActivityInstance> getUnfinished(@PathVariable String processId) throws ParseException {
    ...
    public @ResponseBody
    List<Object> getHistoryInfo(@PathVariable String id) throws ParseException {
    ...
    public @ResponseBody
    Response getAssigneeByUserId(@PathVariable String processId) throws ParseException {
    ...
    public @ResponseBody
    Response getAssigneeByUserId_plan(@PathVariable String processId) throws ParseException {
