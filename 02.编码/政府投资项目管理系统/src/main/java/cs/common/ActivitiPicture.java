...
@Controller
@RequestMapping(name = "后台管理--工作台管理", path = "pic/task")
public class ActivitiPicture {
	 ...
	 * 读取带跟踪的图片
	 */
	@RequestMapping(name = "已办列表页--计划类展示信息", value = "/picture/{processInstanceId}", method = RequestMethod.GET)
	public void test(HttpServletResponse response, @PathVariable String processInstanceId) throws Exception {
		...
		// 中文显示的是口口口，设置字体就好了
		InputStream imageStream = ProcessDiagramGenerator.generateDiagram(bpmnModel, "png", highLightedActivitis,
				highLightedFlows);
		// 单独返回流程图，不高亮显示
