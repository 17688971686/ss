...
public class SQLConfig {
 ...
 public static String projectStatisticsByUnit = String.format("SELECT"
 		...
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_1' THEN 1 ELSE 0 END) AS prereserveNumbers,"
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_2' THEN 1 ELSE 0 END) AS preNumbers,"
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_3' THEN 1 ELSE 0 END) AS constructionNumbers,"
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_4' THEN 1 ELSE 0 END) AS shutdownNumbers,"
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_5' THEN 1 ELSE 0 END) AS completedNumbers,"
 		+ " SUM(CASE WHEN p.projectStage = 'projectStage_6' THEN 1 ELSE 0 END) AS fixedAssetsNumbers,"
 		+ " SUM( IFNULL(p.projectInvestSum,0)) AS projectInvestSum"
 ...
 public static String approvalStatisticsByStage = String.format("SELECT"
 		...
 		+ " WHERE sbi.projectShenBaoStage = b.id AND sbi.projectShenBaoStage IN ('projectShenBaoStage_1','projectShenBaoStage_2','projectShenBaoStage_3','projectShenBaoStage_4')"
 ...
 public static String approvalStatisticsByIndustry = String.format("SELECT"
 		+ " b.description AS classDesc,count(sbi.id) AS projectNumbers,SUM(IFNULL(sbi.projectInvestSum,0)) AS projectInvestSum"
 		+ " FROM cs_shenbaoinfo AS sbi,cs_basicdata AS b"
 		+ " WHERE sbi.projectIndustry = b.id AND sbi.projectShenBaoStage IN ('projectShenBaoStage_1','projectShenBaoStage_2','projectShenBaoStage_3','projectShenBaoStage_4')"
 		+ " AND YEAR(sbi.pifuDate) = :pifuDate"
 		+ " GROUP BY sbi.projectIndustry ORDER BY b.itemOrder");
 
 public static String approvalStatisticsByUnit = String.format("SELECT"
 		+ " b.description AS classDesc,u.unitName,"
 		+ " SUM(CASE WHEN sbi.projectShenBaoStage = 'projectShenBaoStage_1' THEN 1 ELSE 0 END) AS approvalStageXMJYSNumbers,"
 		+ " SUM(CASE WHEN sbi.projectShenBaoStage = 'projectShenBaoStage_2' THEN 1 ELSE 0 END) AS approvalStageKXXYJBGNumbers,"
 		+ " SUM(CASE WHEN sbi.projectShenBaoStage = 'projectShenBaoStage_3' THEN 1 ELSE 0 END) AS approvalStageCBSJGSNumbers,"
 		+ " SUM(CASE WHEN sbi.projectShenBaoStage = 'projectShenBaoStage_4' THEN 1 ELSE 0 END) AS approvalStageZJSQBGNumbers,"
 		+ " SUM(IFNULL(sbi.projectInvestSum,0)) AS projectInvestSum"
 		+ " FROM cs_shenbaoinfo AS sbi,cs_basicdata AS b,cs_userunitinfo AS u"
 		+ " WHERE sbi.projectShenBaoStage = b.id AND sbi.unitName=u.id AND sbi.projectShenBaoStage IN ('projectShenBaoStage_1','projectShenBaoStage_2','projectShenBaoStage_3','projectShenBaoStage_4')"
 		+ " AND YEAR(sbi.pifuDate) = :pifuDate"
