...
public class SQLConfig {
 ...
 public static String yearPlanProject=String.format("SELECT"
	 		...
	 		+ " t2.capitalSum YearInvestApproval,t2.id yearPlanCapitalId,t1.complate,t1.thisTaskId,t1.thisTaskName,t1.zong_processId,t1.isIncludPack,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao"
 ...
 public static String packPlanByUnit = String.format("SELECT"
	 		+ 	" p.id,p.createdBy,p.createdDate,p.itemOrder,p.modifiedBy,p.modifiedDate,p.name,p.remark,p.year,p.totalMoney"
...
public static String packPlanByYearPlanId = String.format("SELECT"
	 		+ 	" p.id,p.createdBy,p.createdDate,p.itemOrder,p.modifiedBy,p.modifiedDate,p.name,p.remark,p.year,p.totalMoney,p.capitalSCZ_ggys_TheYear,p.capitalSCZ_gtzj_TheYear"
//	 		+ 	" t3.id yearPlanId"
	 		+ " FROM cs_packPlan p"
...
public static String shenBaoInfoOfPlanReachApplication = String.format("SELECT"
		 	...
		 	+ " t1.yearConstructionContentLastTwoYear,t1.yearConstructionContentLastYear,t1.yearConstructionContentShenBao,t1.yearConstructionTask,t1.yearImageSchedule,t1.yearInvestApproval,t1.yearInvestApproval_lastTwoYear,t1.yearInvestApproval_lastYear,"
		 	+ " t1.bianZhiUnitInfo_id,t1.shenBaoUnitInfo_id,t1.packageType,t1.receiver,t1.capitalOtherDescriptionShenBao_LastYear,t1.capitalOtherDescriptionShenBao_LastTwoYear,t1.isApplyOutsideCapital,t1.applyOutsideCapital,t1.isIncludYearPlan,"
		 	+ " t1.sqPlanReach_ggys,t1.sqPlanReach_gtzj,t1.isPlanReach,t1.apPlanReach_ggys,t1.apPlanReach_gtzj,t1.shenbaoDate,t1.qianshouDate,t1.pifuDate,t1.nationalIndustry,t1.complate,t1.thisTaskId,t1.thisTaskName,t1.zong_processId,t1.yearPlanCapitalId,t1.isIncludPack,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao"
...
public static String shenBaoInfoOfPackPlanOfPlanReach = String.format("SELECT"
		 	...
		 	+ " t1.yearConstructionContentLastTwoYear,t1.yearConstructionContentLastYear,t1.yearConstructionContentShenBao,t1.yearConstructionTask,t1.yearImageSchedule,t1.yearInvestApproval,t1.yearInvestApproval_lastTwoYear,t1.yearInvestApproval_lastYear,"
		 	+ " t1.bianZhiUnitInfo_id,t1.shenBaoUnitInfo_id,t1.packageType,t1.receiver,t1.capitalOtherDescriptionShenBao_LastYear,t1.capitalOtherDescriptionShenBao_LastTwoYear,t1.isApplyOutsideCapital,t1.applyOutsideCapital,t1.isIncludYearPlan,"
		 	+ " t1.sqPlanReach_ggys,t1.sqPlanReach_gtzj,t1.isPlanReach,t1.apPlanReach_ggys,t1.apPlanReach_gtzj,t1.isIncludPack,t1.shenbaoDate,t1.qianshouDate,t1.nationalIndustry,t1.yearPlanCapitalId,t1.pifuDate,t1.complate,t1.thisTaskId,t1.thisTaskName,t1.zong_processId,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao"
//	 		+ " p.id,p.createdBy,p.createdDate,p.itemOrder,p.modifiedBy,p.modifiedDate,"
//	 		+ " p.applicationName,p.applicationTime,p.applicationUnit,p.resPerson,p.resPersonTel"
	 		+ " FROM cs_shenbaoinfo t1"
