...
public class SQLConfig {
    ...
    public static String getYearPlanProject(boolean exclude) {
        return "SELECT t1.id,t1.createdBy,t1.createdDate,t1.itemOrder,t1.modifiedBy," +
                ...
                "t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser,t1.monitor_status,t1.xdPlanReach_gtzj,t1.xdPlanReach_ggys,t1.pifuSCQQJFXD_wenhao,t1.isRecords,t1.pfProjectInvestSum,t1.pifuSCQQJFXD_date"
...
//	 		+ 	" t3.id yearPlanId"
    ...
    public static String shenBaoInfoOfPlanReachApplication = "SELECT"
            ...
            + "t1.isIncludPack,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao,t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser,t1.monitor_status,t1.xdPlanReach_gtzj,t1.pfProjectInvestSum,t1.xdPlanReach_ggys,t1.pifuSCQQJFXD_wenhao,t1.isRecords,t1.pifuSCQQJFXD_date"
...
//	 		+ " p.applicationName,p.applicationTime,p.applicationUnit,p.resPerson,p.resPersonTel"
    ...
    public static String shenBaoInfoOfPackPlanOfPlanReach = "SELECT"
            ...
            + "t1.thisTaskName,t1.zong_processId,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao,t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser,t1.monitor_status,t1.xdPlanReach_gtzj,t1.isRecords,t1.pfProjectInvestSum,t1.xdPlanReach_ggys,t1.pifuSCQQJFXD_wenhao,t1.pifuSCQQJFXD_date"
//	 		+ " p.id,p.createdBy,p.createdDate,p.itemOrder,p.modifiedBy,p.modifiedDate,"
//	 		+ " p.applicationName,p.applicationTime,p.applicationUnit,p.resPerson,p.resPersonTel"
