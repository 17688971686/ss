...
public class SQLConfig {
 ...
 public static String yearPlanProject=String.format("SELECT"
	 		...
	 		+ " t2.capitalSum YearInvestApproval,t2.id yearPlanCapitalId,t1.complate,t1.thisTaskId,t1.thisTaskName,t1.zong_processId,t1.isIncludPack,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao,t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser"
...
public static String shenBaoInfoOfPlanReachApplication = String.format("SELECT"
		 	...
		 	+ "t1.isIncludPack,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao,t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser"
...
public static String shenBaoInfoOfPackPlanOfPlanReach = String.format("SELECT"
		 	...
		 	+ "t1.thisTaskName,t1.zong_processId,t1.pifuZJSQBG_date,t1.pifuZJSQBG_wenhao,t1.monitor_processId,t1.isSubShenBaoAtt,t1.isLeaderHasRead,t1.thisUser"
//	 		+ " p.id,p.createdBy,p.createdDate,p.itemOrder,p.modifiedBy,p.modifiedDate,"
//	 		+ " p.applicationName,p.applicationTime,p.applicationUnit,p.resPerson,p.resPersonTel"
	 		+ " FROM cs_shenbaoinfo t1"
