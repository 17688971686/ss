 ...
 *
 */
public class ExcelReportPlanReachView extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        Sheet sheet = workbook.createSheet("计划下达导出");
    ...
    private static void createCell(List<ExcelReportPlanReachDto> data,
        ...
        for (ExcelReportPlanReachDto dto : data) {
            ...
            createCell(dto.getShPlanReach_ggys(),7,row,wb,ha,va,fontHeight,fontName,fontCs,isBorder);
            createCell(dto.getShPlanReach_gtzj(),8,row,wb,ha,va,fontHeight,fontName,fontCs,isBorder);
            ...
            createCell(dto.getPlanName(),12,row,wb,ha,va,fontHeight,fontName,fontCs,isBorder);
            startRowNum++;
        }
    }
