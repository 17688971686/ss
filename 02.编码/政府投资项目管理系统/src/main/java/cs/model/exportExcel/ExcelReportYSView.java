...
public class ExcelReportYSView extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        createCellAlignCenter(workbook,row_head1,8,"其中");
        ...
        for (ExcelDataYS data:excelDataList) {
            ...
            createCellAlignCenter(workbook,row1,0, data.getNo());
            if(data.isHB()){
            	createCellAlignCenter(workbook,row1,2, data.getConstructionScale());
            	createCellAlignCenter(workbook,row1,1, data.getConstructionUnit());
            }else{
            ...
            createCellAlignCenter(workbook,row1,7, data.getYearApSum());//安排投资
            ...
            createCellAlignLeft(workbook,row1,10, data.getConstructionContent());//建设内容
