...
//			projectDto.setIsPlanReach(project.getIsPlanReach());
			projectDto.setAlreadyDisbursed(project.getAlreadyDisbursed());
			projectDto.setCountryNumber(project.getCountryNumber());
			//资金来源			
			...
			projectDto.setPifuSCQQJFXD_date(project.getPifuSCQQJFXD_date());
			projectDto.setPifuSCQQJFXD_wenhao(project.getPifuSCQQJFXD_wenhao());
			//基础数据
...
//			project.setIsPlanReach(projectDto.getIsPlanReach());
			...
			project.setCountryNumber(projectDto.getCountryNumber());
			//资金来源			
			...
			project.setPifuSCQQJFXD_date(projectDto.getPifuSCQQJFXD_date());
			project.setPifuSCQQJFXD_wenhao(projectDto.getPifuSCQQJFXD_wenhao());
			//基础信息
