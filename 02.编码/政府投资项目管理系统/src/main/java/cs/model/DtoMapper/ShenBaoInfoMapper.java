...
public class ShenBaoInfoMapper implements IMapper<ShenBaoInfoDto, ShenBaoInfo> {
	...
	public ShenBaoInfoDto toDto(ShenBaoInfo entity) {
		...
		if(entity!=null){			
			...
			//下一年度计划三年滚动--第一年
			shenBaoInfoDto.setPlan_wenhao(entity.getPlan_wenhao());
			...
			//三年滚动--第三年
			shenBaoInfoDto.setApplyAPYearInvest(entity.getApplyAPYearInvest());
...
//			shenBaoInfoDto.setIsPlanReach(entity.getIsPlanReach());
			...
			shenBaoInfoDto.setIsFaWen(entity.getIsFaWen());
			shenBaoInfoDto.setPlanReachConstructionContent(entity.getPlanReachConstructionContent());
			shenBaoInfoDto.setYearPlanRemark(entity.getYearPlanRemark());
			shenBaoInfoDto.setActiveRelease(entity.getActiveRelease());
			//基础数据		
	...
	public ShenBaoInfo buildEntity(ShenBaoInfoDto shenBaoInfoDto, ShenBaoInfo shenBaoInfo) {
		if(shenBaoInfoDto !=null && shenBaoInfo !=null){
			...
			//三年滚动--第三年
			shenBaoInfo.setApplyAPYearInvest(shenBaoInfoDto.getApplyAPYearInvest());
...
//			shenBaoInfo.setIsPlanReach(shenBaoInfoDto.getIsPlanReach());
			...
			shenBaoInfo.setIsFaWen(shenBaoInfoDto.getIsFaWen());
			shenBaoInfo.setPlanReachConstructionContent(shenBaoInfoDto.getPlanReachConstructionContent());
			shenBaoInfo.setYearPlanRemark(shenBaoInfoDto.getYearPlanRemark());
			shenBaoInfo.setActiveRelease(shenBaoInfoDto.getActiveRelease());
			//begin#审批相关
