...
public class ProjectStatisticsView extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		String typeDesc=type.equals("unit")?"项目单位"
                :type.equals("category")?"项目类别"
                :type.equals("industry")?"项目行业"
                :type.equals("stage")?"项目阶段"
                :type.equals("projectName")?"项目名称"
                :"";

		isIncludLibrary=isIncludLibrary.equals("true")?"已纳入项目库项目"
                :isIncludLibrary.equals("false")?"未纳入项目库项目"
        ...
        cellRangeTitle = type.equals("unit")?new CellRangeAddress(0,0,0,8)
                :type.equals("projectName")?new CellRangeAddress(0,0,0,5)
        ...
        }else if(type.equals("projectName")){
            //设置子标题列宽
        ...
        //begin#数据列
        int rowNum=type.equals("unit")?4
                :type.equals("projectName")?3
                :3;//数据加载开始行
        int index=1;
