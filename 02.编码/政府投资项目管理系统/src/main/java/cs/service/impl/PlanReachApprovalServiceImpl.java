...
//		shenBaoInfo.setEndDate(new SimpleDateFormat("yyyy-MM").format(new Date()));
    ...
    public void updateShnebaoInfo(String shenbaoId, Double ggmoney, Double gtmoney) {
       ...
       YearPlanYearContent yearPlanYearContent = entity.getYearPlanYearContent();
        ...
        if(ggmoney+yearPlanYearContent.getApInvestSum() -entity.getXdPlanReach_ggys() > entity.getProjectInvestSum() || 
        		gtmoney+yearPlanYearContent.getApInvestSum() -entity.getXdPlanReach_gtzj()> entity.getProjectInvestSum()){
        ...
        yearPlanYearContent.setApInvestSum(yearPlanYearContent.getApInvestSum()+gtmoney+ggmoney-entity.getXdPlanReach_ggys()-entity.getXdPlanReach_gtzj());
