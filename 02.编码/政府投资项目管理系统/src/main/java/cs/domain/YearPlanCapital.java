...
public class YearPlanCapital extends BaseEntity {
	...
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-市财政-公共预算'")
	private Double capitalSCZ_ggys;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-市财政-国土资金'")
	private Double capitalSCZ_gtzj;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-市财政-专项资金'")
	private Double capitalSCZ_zxzj;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-区财政-公共预算'")
	private Double capitalQCZ_ggys;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-区财政-国土资金'")
	private Double capitalQCZ_gtzj;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-中央预算内投资'")
	private Double capitalZYYS;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-社会投资'")
	private Double capitalSHTZ;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金筹措方案-其它'")
	private Double capitalOther;
	
	@Column(columnDefinition="double(10,4) NULL COMMENT '资金总和'")
